...
export class GameScene extends Phaser.Scene {
  ...
  public update(): void {
    /**
    * Every frame, we create a new velocity for the sprite based
    * on what keys the player is holding down.
    */
    ...
    /**
    * We normalize the velocity so that the player is always
    * moving at the same speed, regardless of direction.
    */
